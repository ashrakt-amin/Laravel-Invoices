	...
	<div class="main-sidemenu">
		<div class="app-sidebar__user clearfix">
			<div class="dropdown user-pro-body">
				...
				<div class="user-info">
					<h4 class="font-weight-semibold mt-3 mb-0">{{Auth::user()->name}} <? echo __('dashboard.welcome') ?></h4>
		...
		<ul class="side-menu">
			<li class="slide">
				<a class="side-menu__item" href="{{ url('/' . $page='index') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
					...
					</svg><span class="side-menu__label">{{ __('Home') }}</span></a>
			</li>

			@can('invoices')
			<li class="side-item side-item-category">{{ __('Invoices') }}</li>
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ route('invoices.index') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
						<path d="M0 0h24v24H0V0z" fill="none" />
					...
					</svg><span class="side-menu__label"> {{ __('Invoices') }}</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					@can('invoices list ')<li><a class="slide-item" href="{{ route('invoices.index') }}">{{ __('Invoices List') }} </a></li>@endcan
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
					...
					</svg><span class="side-menu__label">{{ __('Reports') }} </span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					@can('invoices reports ')<li><a class="slide-item" href="{{ route('reports.index') }}">{{ __('Invoices') }} </a></li>@endcan
					@can('user reports ')<li><a class="slide-item" href="{{route('reports.user') }}">{{ __('Clients') }} </a></li>@endcan
			...
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
					...
					</svg><span class="side-menu__label">{{ __('Users') }}</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					@can('users list ')<li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">{{ __('users list') }}</a></li>@endcan
					@can('users permissions ')<li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">{{ __('permissions') }} </a></li>@endcan
			...
			@can('setting')
			<li class="side-item side-item-category">{{ __('Setting') }}</li>
			<li class="slide">
				<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon" viewBox="0 0 24 24">
					...
					</svg><span class="side-menu__label">{{ __('Setting') }}</span><i class="angle fe fe-chevron-down"></i></a>
				<ul class="slide-menu">
					@can('products')<li><a class="slide-item" href="{{route('section.index') }}">{{ __('sections') }} </a></li>@endcan
					@can('sections')<li><a class="slide-item" href="{{route('products.index') }}">{{ __('products') }} </a></li>@endcan
				</ul>
			</li>
			@endcan
