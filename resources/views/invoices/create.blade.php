                ...
                <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputName" name="invoice_number" title="" required>
                        </div>

                        <div class="col">
                            <label>invoice date</label>
                            <input class="form-control fc-datepicker" name="invoice_date" placeholder="DD-MM-YYYY" type="date"  required>
                        </div>

                        <div class="col">
                            <label>invoice due </label>
                            <input class="form-control fc-datepicker" name="due_date" placeholder="DD-MM-YYYY" type="date" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control form-control-lg" id="Amount_Commission" name="Amount_Commission"  required>
                        </div>

                        <div class="col">
                            <label for="inputName" class="control-label">discount</label>
                            <input type="text" class="form-control form-control-lg" id="Discount" name="discount" value=0 required>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <select name="rate_vat" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                <!--placeholder-->
                                <option value="" selected disabled>-- choose VAT rate --</option>
